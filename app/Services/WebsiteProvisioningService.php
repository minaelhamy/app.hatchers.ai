...
class WebsiteProvisioningService
{
    ...
    public function applyWebsiteSetup(Founder $founder, array $input): array
    {
        ...
        $payload = [
            ...
            'business_hours' => trim((string) ($input['business_hours'] ?? '')),
            'whatsapp_number' => trim((string) ($input['whatsapp_number'] ?? '')),
            'google_review_url' => trim((string) ($input['google_review_url'] ?? '')),
            'enable_online_booking' => (bool) ($input['enable_online_booking'] ?? false),
            'enable_service_menu' => (bool) ($input['enable_service_menu'] ?? false),
            'enable_shop_menu' => (bool) ($input['enable_shop_menu'] ?? false),
