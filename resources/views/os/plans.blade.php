...
@section('content')
    <div class="public-shell">
        <section class="hero">
            ...
            <p class="muted">Founders can start with a 7-day free trial, choose the self-serve operating system, or build with mentor guidance.</p>
        </section>

        @if (session('error'))
            <section class="card" style="border-color: rgba(179, 34, 83, 0.25); background: rgba(179, 34, 83, 0.06); margin-bottom: 22px;">
