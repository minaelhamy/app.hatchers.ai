...
@section('head')
    <style>
        ...
        .marketing-embed { padding:20px 22px 24px; background:var(--surface); min-height:100%; }
...
@section('content')
    @php ob_start(); @endphp
    <div class="{{ $osEmbedMode ? 'marketing-embed' : 'workspace' }}">
        <div class="panel">
    ...
    @php $marketingContent = ob_get_clean(); @endphp
