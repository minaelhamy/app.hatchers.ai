    ...
    <div class="ops-shell">
        ...
        <aside class="ops-rightbar">
            <div class="ops-rightbar-inner">
                ...
                <div class="mini-note" style="margin-top:18px;">Bookings now have a dedicated OS view. The next deeper step is item-level booking details and status actions without leaving Hatchers Ai Business OS.</div>
            </div>
        </aside>
    </div>
@endsection
