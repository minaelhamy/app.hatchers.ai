...
@section('head')
    <style>
        ...
        .analytics-embed { padding:20px 22px 24px; background:var(--surface); min-height:100%; }
...
@section('content')
    @php ob_start(); @endphp
    <div class="{{ $osEmbedMode ? 'analytics-embed' : 'workspace' }}">
        <div class="panel">
    ...
    @php $analyticsContent = ob_get_clean(); @endphp
